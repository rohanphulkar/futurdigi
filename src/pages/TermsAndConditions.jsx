  ...
  return (
    <div>
      <div className="max-w-[85rem] mx-auto">
        <section>
          <div className="px-4 py-24 text-left bg-gray-50 md:text-center">
          ...
          <div className="px-4 mx-auto prose-lg ld:prose-xl">
            <div>
              <p className="text-2xl">Welcome to Coderlink!</p>
              <p>
                These terms and conditions outline the rules and regulations for
                the use of coderlink's Website, located at https://coderlink.co.
              </p>
              <p>
                By accessing this website we assume you accept these terms and
                conditions. Do not continue to use Coderlink if you do not agree
              ...
              <p>
                We employ the use of cookies. By accessing Coderlink, you agreed
                to use cookies in agreement with the coderlink's Privacy Policy.
                {"{"}" "{"}"}
              </p>
              <p>
              ...
              <p>
                Unless otherwise stated, coderlink and/or its licensors own the
                intellectual property rights for all material on Coderlink. All
                intellectual property rights are reserved. You may access this
                from Coderlink for your own personal use subjected to
                restrictions set in these terms and conditions.
              </p>
              <p>You must not:</p>
              <ul>
                <li>Republish material from Coderlink</li>
                <li>Sell, rent or sub-license material from Coderlink</li>
                <li>Reproduce, duplicate or copy material from Coderlink</li>
                <li>Redistribute content from Coderlink</li>
              </ul>
              <p>
                Parts of this website offer an opportunity for users to post and
                exchange opinions and information in certain areas of the
                website. coderlink does not filter, edit, publish or review
                Comments prior to their presence on the website. Comments do not
                reflect the views and opinions of coderlink,its agents and/or
                affiliates. Comments reflect the views and opinions of the
                person who post their views and opinions. To the extent
                permitted by applicable laws, coderlink shall not be liable for
              ...
              <p>
                coderlink reserves the right to monitor all Comments and to
              ...
              <p>
                You hereby grant coderlink a non-exclusive license to use,
              ...
              <p>
                ...
                of coderlink; and (d) the link is in the context of general
              ...
              <p>
                ...
                by sending an e-mail to coderlink. Please include your name,
              ...
              <p>
                No use of coderlink's logo or other artwork will be allowed for
