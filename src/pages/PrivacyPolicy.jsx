          ...
          <div className="px-4 mx-auto prose-lg ld:prose-xl">
            <div>
              ...
              <ul>
                ...
                <li>
                  <p>
                    <strong>Website</strong> refers to Coderlink, accessible
                    from
                    {"{"}" "{"}"}
                    <a
                      href="https://coderlink.co"
              ...
              <ul>
                <li>
                  <p>By email: contact@coderlink.co</p>
                </li>
                <li>
                  <p>
                    By visiting this page on our website:{"{"}" "{"}"}
                    <a
                      href="https://coderlink.co/#contact"
                      rel="external nofollow noopener"
                      target="_blank"
                    >
                      https://coderlink.co/contact
                    </a>
                  </p>
                </li>
              </ul>
